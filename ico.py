...
draw.rounded_rectangle(
    [(clipboard_x, clipboard_y), (clipboard_x +
                                  clipboard_width, clipboard_y + clipboard_height)],
    radius=10,
...
draw.rounded_rectangle(
    [(clip_x, clipboard_y - clip_height // 2),
...
for i in range(5):
    ...
    line_width = line_width_full if i < 3 else line_width_half
    draw.rounded_rectangle(
        [(clipboard_x + 15, y_position), (clipboard_x +
                                          15 + line_width, y_position + line_height)],
        radius=5,
        fill=line_color
    )
...
icons[0].save('assets/CopyClip_logo.ico', sizes=[(16, 16), (32, 32), (48, 48), (64, 64), (128, 128), (256, 256)],
              format='ICO')
